...
export default function VideoShowcase() {
  ...
  return (
    <section className="py-14 sm:py-24 bg-bg-surface/40 border-b border-border overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <FadeIn delay={0.1}>
          <div className="relative rounded-card border border-border overflow-hidden bg-bg-surface aspect-video">
