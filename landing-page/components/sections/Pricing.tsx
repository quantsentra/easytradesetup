    ...
    <section id="pricing" className="py-14 sm:py-24 bg-bg-surface/40 border-y border-border">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <FadeIn delay={0.15} className="max-w-xl mx-auto">
          <div className="relative rounded-card border-glow bg-bg-surface shadow-glow animate-glow-pulse p-8 flex flex-col">
            ...
            <a
              href="/contact"
              className="block text-center py-4 px-8 rounded-xl font-bold text-base transition-all duration-200
                bg-accent-green text-black hover:bg-accent-green/90 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-accent-green/20
                shadow-glow-green"
            >
