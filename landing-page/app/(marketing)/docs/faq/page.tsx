...
const faqs = [
  ...
  },
  {
    ...
    items: [
      ...
      ["What if I have install or usage problems?", "Open a support ticket from your portal — portal.easytradesetup.com/support. A human replies within 24h with a fix. The script is Pine v5 standard; if it does not render or behaves unexpectedly, we walk you through the resolution."],
