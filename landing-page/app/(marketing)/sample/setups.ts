...
export const SETUPS: Setup[] = [
...

  {
    ...
    label: "Crypto",
    short: "Crypto",
    chapter: "Free sample · BTC / USD",
    title: "Lifeline Buy — Bitcoin (BTC / USD)",
    symbol: "BTC · 15m · 24/7 — Lifeline-anchored",
    images: [
      {
        src: "/btc-lifeline.png",
        alt: "Bitcoin (BTC/USD) 15-minute chart with the Golden Indicator's Lifeline plotted in black and a Buy signal printing above it",
        caption: "BTC / USD · Buy setup",
      },
    ],
    intro:
      "Crypto trades 24/7 — that's its blessing and its curse. Without session structure, retail traders chase every wick. The Lifeline solves that. The black trailing line on your BTC chart is the Lifeline (McGinley-derived, smooth in trend, fast on reversal); it stays patient through chop and turns fast on real direction. The 15-minute timeframe is the suggested setting — slow enough to filter wicks, fast enough to catch the move. When a Buy signal prints above the Lifeline and the next candle confirms with a close above it, you take the entry, define risk under the line, and let the trend run.",
    oneLiner: {
      before: "On the BTC 15-minute chart, when a Golden Indicator ",
      highlight: "Buy signal prints above the Lifeline",
      mid: " and the next candle closes above that signal candle,",
      after: " enter on the candle that follows the confirmation close, place your stop below the signal candle or the Lifeline, target 1:2 RR — and trail the runner with the Lifeline as far as the move wants to go.",
    },
    entries: [
      "Set the chart to BTC / USD on the 15-minute timeframe. This is the suggested timeframe — BTC's structure reads cleanly here without 1m noise or 1h lag.",
      "Identify the black Lifeline plotted by the Golden Indicator. Price above = bullish bias. Price below = stand aside for longs.",
      "Wait for a Buy (B) signal to print above the Lifeline. Signal candle must close — no acting on intra-bar prints. Crypto wicks are vicious; the close-only rule is your filter.",
      "Confirmation: wait for the next candle to close ABOVE the Buy signal candle's high. No close-above = no trade. Filters fake breakouts where BTC wicks then reverses straight back into the Lifeline.",
      "Enter at the open of the candle that follows the confirmation close. Do not chase inside the signal or confirmation candle.",
    ],
    exits: [
      { k: "Stop loss", v: "Below the Buy signal candle low, OR the previous candle low, OR just below the Lifeline — whichever is structurally tightest without being noise. Crypto wicks long; pick a level that respects that. Pick before you enter. Never widen." },
      { k: "Target 1 · book half", v: "1:2 reward-to-risk. Book half. Move the remaining stop to cost (breakeven). The trade is now risk-free." },
      { k: "Target 2 · let it run", v: "Unlimited. Trail the stop along the Lifeline as it pivots. BTC trends extend — when momentum + funding + perp basis align, runners deliver 5R, 8R, sometimes 10R+. Let the Lifeline do the trail." },
      { k: "Hard exit", v: "Close below the Lifeline = trend over. Exit at market regardless of where the trade is. The line is the line in the sand." },
    ],
    invalidation:
      "A close below the Lifeline before Target 1 = the trend has flipped. Exit immediately, take the full 1R loss, and stand aside. Do not average down. Do not flip on a single liquidation cascade headline. The Lifeline broke — wait for a fresh setup with fresh structure.",
    why:
      "BTC trades on macro liquidity, perp funding, ETF flow, and miner economics — none of which respect session times. The Lifeline filters that 24/7 noise from genuine direction the way McGinley designed it: slow in trend, fast on reversal. On the 15m timeframe, BTC structure reads cleanly without the wick-trap that ruins 1m and 5m strategies. Buy signals above the line catch the moves where momentum has already taken the cost-basis side off the table — the moves that extend.",
    risk: [
      ["Risk per trade", "2% of account — hard cap. Never bigger."],
      ["3 losses in a row", "Stop trading for the day. Psychology breaks before the math does. BTC will be there tomorrow."],
      ["3 wins in a row", "Stop trading for the day. Lock the day. Heat fades fast on the next trade."],
      ["Reward/risk floor", "1:2 minimum at Target 1. No 1:1, no 1:1.5 — too thin for variance, especially on crypto."],
      ["Trail rule", "Above Lifeline → stay long. Lifeline broken → exit. No exceptions."],
    ],
  },
